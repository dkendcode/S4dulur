...
elseif($getsprice == "25000"){ $color = "#008000";}
elseif($getsprice == "45000"){ $color = "#FF00FF";}
...
<small style="font-size:10px;margin-left:-17px;position:absolute;"><?=$currency?> </small><?php echo $getsprice;?>
</div>	
</td>		
</tr>
</tbody>
...
Hubungkan ke wifi S4dulur.Net <br/>
Buka browser ketik  : S4dulur.Net 
</div>
</td>	
...
<div style="float:right;padding:1px;text-align:right;width:70%;margin:0 1px -20px 0;"><?= $qrcode ?></div>
</td>		
</tr>
<tr>
