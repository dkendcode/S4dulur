...
if(!isset($_SESSION["mikhmon"])){
  ...
  if(isset($_POST['name'])){
    ...
    if($reportmode=="telegram"){
      $up = '[/tool fetch url="https://api.telegram.org/bot'.$nwtoken.'/sendmessage?chat_id='.$nwcid.'&text============================%0A%10%10%10%10%10%10%10*S4dulur%10Netwatch%10Monitor*%0A===========================%0AName : '.$name.'%0AStatus : Normal&parse_mode=markdown" keep-result=no]';
      $down = '[/tool fetch url="https://api.telegram.org/bot'.$nwtoken.'/sendmessage?chat_id='.$nwcid.'& text============================%0A%10%10%10%10%10%10%10*S4dulur%10Netwatch%10Monitor*%0A===========================%0AName : '.$name.'%0AStatus : Down&parse_mode=markdown" keep-result=no]';
    }
